...
g++ -c -Wall -std=c++20 -O3 -Dlibreadline -Ddebug4  -I/usr/local/Cellar/boost/1.76.0/include -I/usr/local/opt/readline/include AscalMain.cpp AscalParameters.cpp Object.cpp   string_view.cpp Ascal.cpp AscalExecutor.cpp  ParsingUtil.cpp PRNG.cpp Keyword.cpp MemoryMap.cpp MemoryManager.cpp SubStr.cpp 
