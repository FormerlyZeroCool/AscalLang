echo "Building Ascal Interpreter with g++ -o22"
g++ -c -O2 -std=c++17 AscalMain.cpp AscalFrame.hpp AscalParameters.cpp Object.cpp queue.hpp setting.hpp stack.hpp unsortedlist.hpp ObjectKey.cpp
