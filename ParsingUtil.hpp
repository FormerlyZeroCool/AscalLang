...
public:
	...
	static string_view getExprInStringSV(const std::string &data,uint32_t &index,char opening,char closing,char lineBreak);
	...
	static string_view getVarNameSV(const std::string &s,uint32_t &index);
